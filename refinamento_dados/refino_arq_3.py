...
def main_refino_arq3(caminho_arq_3: str, caminho_arq_1: str, print_flag: bool = False) -> None:
    ...
    pasta_destino = "G:/Meu Drive/01_Faculdade/03_Projeto tecnologico/Biblioteca de dados Enade/Modelo_teste/associacao/arq3_refinado.csv"
    dataf_filtrado_arq3.to_csv(pasta_destino, index=False)

    show_df(dataf_filtrado_arq3) if print_flag else None
    return dataf_filtrado_arq3

if __name__ == "__main__":
    caminho_arq_3: str = "G:/Meu Drive/01_Faculdade/03_Projeto tecnologico/Biblioteca de dados Enade/microdados_Enade_2021_LGPD/2.DADOS/microdados2021_arq3.txt"
